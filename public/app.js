...
function renderCatalog() {
  ...
  document.title = archive ? 'Arsip Lomba — Matek Ambis (by Radian)' : 'Matek Ambis (by Radian) — Ruang untuk berprestasi';
...
function showDetail(id) {
  ...
  document.title = `${item.title} — Matek Ambis (by Radian)`;
...
function renderLogin() {
  navActive('admin'); document.title = 'Login Admin — Matek Ambis (by Radian)';
